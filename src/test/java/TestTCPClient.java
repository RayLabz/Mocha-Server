...
public class TestTCPClient extends TCPClient<StringMessageProto.StringMessage> {
    /**
     ...
     */
    public TestTCPClient(Class<StringMessageProto.StringMessage> stringMessageClass, String ipAddress, int port) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        TestTCPClient client = new TestTCPClient(StringMessageProto.StringMessage.class, "localhost", 7080);
        client.start();
    }
